        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-8 w-full max-w-md">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-medium text-gray-600 dark:text-gray-400 block mb-1.5">First name</label>
                <input
                  type="text"
                  placeholder="Jane"
                  value={firstName}
              ...
              <div>
                <label className="text-xs font-medium text-gray-600 dark:text-gray-400 block mb-1.5">Last name</label>
                <input
                  type="text"
                  placeholder="Smith"
                  value={lastName}
          ...
          <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-4 leading-relaxed">
            ...
            <Link href="/terms" className="text-green-800 dark:text-green-400 hover:underline">Terms of Use</Link>
            {' '}and{' '}
            <Link href="/privacy" className="text-green-800 dark:text-green-400 hover:underline">Privacy Policy</Link>
          </p>
